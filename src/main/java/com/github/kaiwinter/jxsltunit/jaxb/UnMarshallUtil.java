...
public final class UnMarshallUtil {
	 ...
	 */
	public static IXsltTest loadTestDefinition(File file) throws JAXBException, SAXException {
		JAXBContext context = JAXBContext.newInstance(XsltTestsuites.class, XsltTestsuite.class);
	 ...
	 */
	public static void marshall(JunitTestsuites testsuites, OutputStream outputStream) throws JAXBException {
